...
func TestCreateDisksRun(t *testing.T) {
	...
	cd := &CreateDisks{
		{Name: "d1", SourceImage: "i1", SizeGB: "100", DiskType: ""},
		{Name: "d2", SourceImage: "projects/global/images/i2", SizeGB: "100", DiskType: ""},
		{Name: "d3", SourceImage: "i1", SizeGB: "100", DiskType: "", NoCleanup: true},
		{Name: "d4", SourceImage: "i1", SizeGB: "100", DiskType: "", ExactName: true}}
