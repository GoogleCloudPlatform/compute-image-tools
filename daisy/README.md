...
```shell
daisy wf.json -project my-other-project \\
              -zone other-zone \\
...
| OAuthPath | string | A local path to JSON credentials for your Project. These credentials should have full GCE permission and read/write permission to GCSPath.|
