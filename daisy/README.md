...
# What is Daisy?
Daisy is a solution for running complex, multi-step
[workflows](#glossary-workflow) on [GCE](#glossary-gce).
...
| Project | string | The GCE and [GCS](#glossary-gcs) API enabled [GCP](#glossary-gcp) project in which to run the workflow. |
