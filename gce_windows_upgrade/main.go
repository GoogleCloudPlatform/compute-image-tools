...
import (
	...
	"github.com/GoogleCloudPlatform/compute-image-tools/gce_windows_upgrade/upgrader"
)
...
var (
	...
	sourceOS               = flag.String("source-os", "", fmt.Sprintf("OS version of the source instance to upgrade. Supported values: %v", strings.Join(upgrader.SupportedVersions, ", ")))
	targetOS               = flag.String("target-os", "", fmt.Sprintf("Version of the OS after upgrade. Supported values: %v", strings.Join(upgrader.SupportedVersions, ", ")))
