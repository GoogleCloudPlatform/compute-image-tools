...
type Env struct {
	XMLName Name   `xml:"http://schemas.dmtf.org/ovf/environment/1 Environment"`
...
// PlatformSection represents platform section
...
// PropertySection represents property section as a list of properties
type PropertySection struct {
	Properties []EnvProperty `xml:"Property"`
}

// EnvProperty represents environment property
...
func (e Env) Marshal() (string, error) {
	...
	return fmt.Sprintf("%s%s", header, x), nil
}
