...
def main():
  ...
  if use_dynamic_template == 'true':
    ...
    is_byos = utils.GetMetadataAttribute('is_byos', raise_on_not_found=False)
    ...
    is_sap = utils.GetMetadataAttribute('is_sap', raise_on_not_found=False)
  ...
  ks_cfg = '/files/ks.cfg'
  kickstart_vars_file = '/tmp/kickstart_vars.cfg'
