...
def main():
  ...
  utils.Execute(['cp', '/files/fai_config/sources/GCE_SPECIFIC',
      config_space + 'files/etc/apt/sources.list.d/gce.list/GCE_SPECIFIC'])
  utils.Execute(['cp', '/files/fai_config/sources/file_modes',
      config_space + 'files/etc/apt/sources.list.d/gce.list/file_modes'])
  utils.Execute(['cp', '/files/fai_config/sources/repository.GCE_SPECIFIC',
  ...
  if google_cloud_repo == "staging" or google_cloud_repo == "unstable":
    ...
    utils.Execute(['cp', '/files/fai_config/sources/repository.GCE_STAGING',
  ...
  if google_cloud_repo == "unstable":
    ...
    utils.Execute(['cp', '/files/fai_config/sources/repository.GCE_UNSTABLE',
