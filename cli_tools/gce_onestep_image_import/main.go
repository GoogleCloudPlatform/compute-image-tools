...
import (
	...
	"github.com/GoogleCloudPlatform/compute-image-tools/cli_tools/gce_onestep_image_import/importer"
...
func main() {
	...
	if err := service.RunWithServerLogging(service.ImageOneStepImportAction, paramLog, project, importEntry); err != nil {
		os.Exit(1)
	}
}
