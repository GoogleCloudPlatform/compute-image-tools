...
func (ovfExportArgs *OVFExportArgs) registerFlags(args []string) error {
	...
	flagSet.Var((*flags.TrimmedString)(&ovfExportArgs.InstanceName), InstanceNameFlagKey,
		"Name of the VM Instance to be exported.")
	flagSet.Var((*flags.TrimmedString)(&ovfExportArgs.MachineImageName), MachineImageNameFlagKey,
		"Name of the Google machine image to be exported.")
	flagSet.Var((*flags.LowerTrimmedString)(&ovfExportArgs.ClientID), ClientIDFlagKey,
	...
	flagSet.Var((*flags.TrimmedString)(&ovfExportArgs.DestinationURI), DestinationURIFlagKey,
		"Google Cloud Storage URI of the OVF or OVA file to export to. For example: gs://my-bucket/my-vm.ovf.")
	flagSet.Var((*flags.LowerTrimmedString)(&ovfExportArgs.OvfFormat), OvfFormatFlagKey,
	...
	flagSet.Var((*flags.TrimmedString)(&ovfExportArgs.ReleaseTrack), ReleaseTrackFlagKey,
