...
// ApplyEnvToWorkflow is a WorkflowTraversal that applies user-customizable values
// to the top-level parent workflow.
type ApplyEnvToWorkflow struct {
	env EnvironmentSettings
}

// Traverse updates properties on wf that correspond to user-specified values
// such as project, zone, and scratch bucket path.
func (t *ApplyEnvToWorkflow) Traverse(wf *daisy.Workflow) error {
