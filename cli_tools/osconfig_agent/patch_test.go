...
func TestNextWindow(t *testing.T) {
	...
	var tests = []struct {
	...
	}{
		{
			...
			PatchWindow{Daily: &Daily{}, StartTime: &TimeOfDay{Hours: 5}, Duration: "3600s"}, // Daily at 5
		...
		},
		{
			...
			PatchWindow{Weekly: &Weekly{Day: "Friday"}, StartTime: &TimeOfDay{Hours: 5}, Duration: "3600s"}, // Weekly on Friday at 5
		...
		},
		{
			...
			PatchWindow{Monthly: &Monthly{DayOfMonth: 5}, StartTime: &TimeOfDay{Hours: 5}, Duration: "3600s"}, // Monthly on the 5th at 5.
			now, // We should be before the patch window
		...
		},
		{
			...
			PatchWindow{Monthly: &Monthly{DayOfMonth: -1}, StartTime: &TimeOfDay{Hours: 5}, Duration: "3600s"}, // Monthly on the last day at 5.
			now, // We should be before the patch window
		...
		},
		{
			...
			PatchWindow{Monthly: &Monthly{OccurrenceOfDay: &OccurrenceOfDay{Day: "Tuesday", Occurrence: 2}}, StartTime: &TimeOfDay{Hours: 5}, Duration: "3600s"}, // Monthly on the second Tuesday at 5
			now, // We should be before the patch window
...
func TestNextWindowErrors(t *testing.T) {
	var tests = []struct {
		...
		{
			"no window",
			PatchWindow{StartTime: &TimeOfDay{Hours: 5}, Duration: "3600s"},
		},
		{
			"bad duration",
			PatchWindow{Daily: &Daily{}, StartTime: &TimeOfDay{Hours: 5}, Duration: "5"},
		},
		{
			"weekly invalid day",
			PatchWindow{Weekly: &Weekly{Day: "Frusday"}, StartTime: &TimeOfDay{Hours: 5}, Duration: "3600s"},
		},
		{
			"monthly invalid day",
			PatchWindow{Monthly: &Monthly{OccurrenceOfDay: &OccurrenceOfDay{Day: "Monderday", Occurrence: 2}}, StartTime: &TimeOfDay{Hours: 5}, Duration: "3600s"},
		},
	}
