...
type Assignment struct {
	...
	// PatchPolicies: List of PatchPolicies to configure on the instances.
	// These are relative
	// resource names of PatchPolicies. For
	// example
	// 'projects/12345/patchPolicies/foo'. If a PatchPolicy referenced here
	// is
	// deleted it will be ignored when instances lookup their configs.
	PatchPolicies []string `json:"patchPolicies,omitempty"`
...
type ListPatchPoliciesResponse struct {
	...
	// PatchPolicies: The list of PatchPolicies.
	PatchPolicies []*PatchPolicy `json:"patchPolicies,omitempty"`
...
type Monthly struct {
	...
	// month on the
	// twelfth. Valid values are -1 and from 1 to 31 inclusive. Use -1
	// to
	// signify that this should occur on the last day of the month. Note
	// that
	// if the month doesn't happen to have an occurrence of this day
	// (for
	// example, not all months have a 31st) the patch will not run that
	// month.
...
type OccurrenceOfDay struct {
	...
	// Occurrence: Occurrence within the month. Valid values are -1 and from
	// 1 to 4
	// inclusive. Use -1 to signify that this should be the "last"
	// occurrence
