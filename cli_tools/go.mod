...
require (
	...
	github.com/GoogleCloudPlatform/compute-image-tools/daisy v0.0.0-20200414213327-359251a2c860
	...
	github.com/GoogleCloudPlatform/osconfig v0.0.0-20200409003927-e84b10eb7b09
	...
	golang.org/x/net v0.0.0-20200324143707-d3edc9973b7e // indirecresource_labeler_testt
