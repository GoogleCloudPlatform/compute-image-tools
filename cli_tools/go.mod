...
require (
	...
	github.com/GoogleCloudPlatform/compute-daisy v0.0.0-20260105205708-11ca08c11fd1
	...
	github.com/GoogleCloudPlatform/compute-image-tools/proto/go v0.0.0-20260225002416-7ce873639036
