...
func (m *MockClient) GetGuestAttributes(arg0, arg1, arg2, arg3, arg4 string) (*v1.GuestAttributes, error) {
	...
	ret0, _ := ret[0].(*v1.GuestAttributes)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockClient) GetInstanceAlpha(arg0, arg1, arg2 string) (*v0_alpha.Instance, error) {
	...
	ret0, _ := ret[0].(*v0_alpha.Instance)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockClient) ListImagesAlpha(arg0 string, arg1 ...compute.ListCallOption) ([]*v0_alpha.Image, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0}
	for _, a := range arg1 {
		varargs = append(varargs, a)
