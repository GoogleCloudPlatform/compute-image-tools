...
//
//	testSetup := []*ovfImportTestProperties{
//		{
//			importParams: &ovfimportparams.OVFImportParams{
//				ClientID:      "test",
...
//	ctx context.Context, testSetup *ovfImportTestProperties, tests chan *junitxml.TestCase,
...
//		context.Context, *junitxml.TestCase, *ovfImportTestProperties, *log.Logger, *testconfig.Project){
...
//	ctx context.Context, testCase *junitxml.TestCase, testSetup *ovfImportTestProperties,
